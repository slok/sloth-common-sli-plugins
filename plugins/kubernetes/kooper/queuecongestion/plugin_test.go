...
import (
	...
	"github.com/slok/sloth-common-sli-plugins/plugins/kubernetes/kooper/queuecongestion"
)
...
`,
	...
	for name, test := range tests {
		t.Run(name, func(t *testing.T) {
			...
			gotQuery, err := queuecongestion.SLIPlugin(context.TODO(), test.meta, test.labels, test.options)
